...
const WhatsAppButton = () => {
  ...
  const message = encodeURIComponent(
    'Bună! Aș dori să fac o programare la Doctor Suciu Dental Clinic.'
  );
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      {/* Popover */}
      <div
        className={`absolute bottom-16 right-0 w-72 bg-white rounded-2xl shadow-hover overflow-hidden transition-all duration-300 ${
          isOpen
