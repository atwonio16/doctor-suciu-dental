...
const ClinicGallery = () => {
  ...
  if (!loading && activeImages.length === 0) {
    return (
      <section id="clinica" className="w-full py-20 bg-white">
        <div className="w-full px-4 sm:px-6 lg:px-12 xl:px-20">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="text-center mb-12">
              ...
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-semibold text-black mb-3">
    ...
    <section id="clinica" className="w-full py-20 bg-white">
      ...
      {lightboxOpen && activeImages[currentImage] && (
        <div className="fixed inset-0 z-50 bg-black/95 flex items-center justify-center" onClick={closeLightbox}>
          <button onClick={closeLightbox} className="absolute top-6 right-6 w-12 h-12 rounded-full bg-white/10 flex items-center justify-center text-white hover:bg-white/20">
            <X className="w-6 h-6" />
          </button>
          <button onClick={(e) => { e.stopPropagation(); prevImage(); }} className="absolute left-6 w-12 h-12 rounded-full bg-white/10 flex items-center justify-center text-white hover:bg-white/20">
            <ChevronLeft className="w-6 h-6" />
          </button>
          <button onClick={(e) => { e.stopPropagation(); nextImage(); }} className="absolute right-6 w-12 h-12 rounded-full bg-white/10 flex items-center justify-center text-white hover:bg-white/20">
            <ChevronRight className="w-6 h-6" />
          </button>
          <img src={activeImages[currentImage].image_url} alt={activeImages[currentImage].title} className="max-w-[90vw] max-h-[85vh] object-contain rounded-lg" />
          <div className="absolute bottom-6 left-1/2 -translate-x-1/2 text-white text-center">
            <p className="font-medium">{activeImages[currentImage].title}</p>
