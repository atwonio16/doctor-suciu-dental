...
const Footer = () => {
  ...
  return (
    <footer className="bg-slate-900 text-white">
      {/* CTA */}
      <div className="w-full px-4 sm:px-6 lg:px-12 xl:px-20 py-12 border-b border-slate-800">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-6">
          <div>
            <h2 className="text-2xl font-bold mb-2">Pregătit pentru un zâmbet nou?</h2>
            <p className="text-slate-400">Programează o consultație gratuită.</p>
          </div>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-8">
          <div className="col-span-2 md:col-span-1">
            <Link to="/" className="block mb-4">
              ...
              <span className="block text-[10px] tracking-[0.2em] text-sky-400">DENTAL CLINIC</span>
            </Link>
            <p className="text-sm text-slate-400 mb-4">
              Clinică stomatologică în Târgoviște. Tratamente moderne, echipă dedicată.
            </p>
            <div className="flex gap-3">
              <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full bg-slate-800 flex items-center justify-center text-slate-400 hover:bg-sky-500 hover:text-white transition-colors">
                <Facebook className="w-4 h-4" />
              </a>
              <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="w-9 h-9 rounded-full bg-slate-800 flex items-center justify-center text-slate-400 hover:bg-sky-500 hover:text-white transition-colors">
          ...
          <div>
            <h4 className="font-semibold text-sm uppercase tracking-wider mb-4">Navigare</h4>
