...
const Footer = () => {
  ...
  return (
    <footer className="bg-[#0f172a] text-white">
      {/* CTA */}
      <div className="w-full px-4 sm:px-6 lg:px-12 xl:px-20 py-12 border-b border-white/10">
        <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-6">
          <div>
            <h2 className="text-2xl font-semibold mb-2 tracking-tight">Pregătit pentru un zâmbet nou?</h2>
            <p className="text-[#94a3b8]">Programează o consultație gratuită.</p>
          </div>
          <Link 
            to="/contact" 
            className="inline-flex items-center gap-2 font-semibold text-sm px-6 py-3 rounded-full transition-all duration-300 bg-white text-[#0f172a] border-2 border-white hover:bg-transparent hover:text-white"
          >
            PROGRAMEAZĂ-TE
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-8">
          <div className="col-span-2 md:col-span-1">
            <Link to="/" className="block mb-4">
              ...
              <span className="block text-[10px] tracking-[0.2em] text-[#0891b2]">DENTAL CLINIC</span>
            </Link>
            ...
            <div className="flex gap-3">
              <a 
                ...
                className="w-9 h-9 rounded-full bg-white/10 flex items-center justify-center text-[#94a3b8] hover:bg-[#0891b2] hover:text-white transition-all"
              >
          ...
          <div>
            <h4 className="font-semibold text-sm uppercase tracking-wider mb-4 text-[#0891b2]">Navigare</h4>
          ...
          <div>
            <h4 className="font-semibold text-sm uppercase tracking-wider mb-4 text-[#0891b2]">Servicii</h4>
            <ul className="space-y-2 text-sm text-[#94a3b8]">
          ...
          <div>
            <h4 className="font-semibold text-sm uppercase tracking-wider mb-4 text-[#0891b2]">Contact</h4>
            <ul className="space-y-3 text-sm text-[#94a3b8]">
              <li className="flex items-start gap-2">
                <MapPin className="w-4 h-4 mt-0.5 flex-shrink-0 text-[#0891b2]" />
