        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
                  ...
                  <div key={index} className="border border-slate-200 rounded-xl overflow-hidden">
                    ...
                    >
                      <div className="flex items-center gap-3">
                        <span className="w-6 h-6 rounded-full bg-gradient-to-r from-sky-500 to-indigo-500 flex items-center justify-center text-white text-xs font-bold">
                          {index + 1}
                        </span>
            ...
            <div className="relative">
              ...
              />
              <div className="absolute -bottom-4 -right-4 bg-sky-500 text-white rounded-2xl p-5 shadow-lg">
