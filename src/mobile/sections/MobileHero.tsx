            ...
            <div className="mt-4 grid gap-2">
              ...
              <div className="grid grid-cols-[1.1fr_1fr] gap-2">
                ...
                <button
                  ...
                  className="flex h-12 items-center justify-center gap-2 rounded-[12px] border border-slate-200 bg-white px-4 text-[14px] font-medium text-slate-700 active:scale-[0.985] transition-transform"
                >
                  Vezi cazuri
