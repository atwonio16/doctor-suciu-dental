  ...
  return (
    ...
    >
      <div className="mx-auto max-w-[560px]">
        <div className="relative overflow-hidden rounded-[24px] border border-slate-200 bg-white p-4 shadow-[0_10px_26px_rgba(15,23,42,0.05)]">
          <div className="relative z-10">
            ...
            <h1 className="whitespace-nowrap text-[clamp(1.55rem,7.6vw,1.95rem)] leading-tight tracking-[-0.03em] text-slate-950">
            ...
            <div className="mt-4 grid grid-cols-2 gap-2 text-[12px] text-slate-600">
              ...
              <a
                ...
                className="rounded-2xl border border-slate-200 bg-white p-3 active:scale-[0.99] transition-transform"
              >
                <div className="mb-1 flex items-center gap-1.5 text-slate-500">
            ...
            <div className="mt-4 overflow-hidden rounded-2xl border border-slate-200 bg-white p-1">
              <div className="relative aspect-[16/11] overflow-hidden rounded-[14px] bg-slate-100">
                ...
                <div className="absolute left-2 top-2 rounded-xl border border-white/80 bg-white/95 px-2.5 py-1.5 shadow-sm">
