  ...
  return (
    ...
    >
      ...
      <div className="mx-auto max-w-[480px] px-5 pb-8">
        ...
        >
          <GoogleMark />
          <span className="text-[15px] font-semibold text-slate-900">{googleReviews.rating.toFixed(1)}</span>
          ...
          <span className="text-[14px] font-medium text-[#2563EB]">din {googleReviews.reviewCount} recenzii</span>
        </a>
        ...
        <div className="mt-4">
          <Link
            to="/contact"
            className="group flex h-[50px] w-full items-center justify-center gap-2 rounded-full bg-[#0B1E32] text-white shadow-lg shadow-slate-900/15 active:scale-[0.98] transition-all"
          >
