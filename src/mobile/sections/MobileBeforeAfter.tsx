    ...
    <section id="transformari" className="mobile-safe-x py-4">
      <div className="mx-auto max-w-[560px]">
        <div className="mobile-panel overflow-hidden p-4">
          ...
          <div
            className="mobile-card overflow-hidden rounded-[16px]"
              ...
              {displayCases.map((caseItem) => (
                <div key={caseItem.id} className="w-full shrink-0 p-3">
                  <div className="grid grid-cols-1 gap-2">
                    ...
                    <div className="mobile-card overflow-hidden">
                      <div className="border-b border-slate-100 bg-[#f7fbff] px-3 py-2">
                        <p className="text-[11px] font-semibold uppercase tracking-[0.14em] text-[#0F2A44]">Dupa</p>
                      </div>
                      <div className="aspect-[16/10] bg-slate-100">
                        <img
