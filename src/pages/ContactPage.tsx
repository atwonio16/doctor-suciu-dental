      ...
      <section className="w-full px-4 sm:px-6 lg:px-12 xl:px-20 pb-12">
        <div className="max-w-7xl mx-auto">
          <FadeText direction="up">
            <Link to="/" className="inline-flex items-center gap-2 text-slate-600 hover:text-sky-500 transition-colors mb-6">
          ...
          <div className="text-center max-w-3xl mx-auto">
            ...
            <FadeText delay={0.3} direction="up">
              <p className="text-lg text-slate-600 leading-relaxed">
                Suntem aici să te ajutăm. Programează o consultație sau contactează-ne pentru orice întrebare.
              </p>
            </FadeText>
          </div>
        </div>
      ...
      <section className="w-full px-4 sm:px-6 lg:px-12 xl:px-20 pb-20">
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16">
              ...
              <FadeText delay={0.4} direction="right">
                <div className="grid sm:grid-cols-2 gap-6">
                  <div className="p-6 bg-slate-50 rounded-2xl">
                    ...
                    <a href="tel:+40770220110" className="text-slate-900 font-semibold hover:text-sky-500 transition-colors">
                      0770 220 110
                    </a>
                  </div>
                  ...
                  <div className="p-6 bg-slate-50 rounded-2xl">
                    ...
                    <a href="mailto:contact@doctorsuciu.ro" className="text-slate-900 font-semibold hover:text-sky-500 transition-colors">
            ...
            {/* Form */}
            <div>
              <FadeText delay={0.4} direction="left">
                <div className="bg-slate-50 rounded-3xl p-6 lg:p-10">
                  <h2 className="font-bold text-2xl text-slate-900 mb-6">
                  ...
                  {isSubmitted ? (
                    <div className="flex flex-col items-center justify-center py-12 text-center">
                      ...
                      <p className="text-slate-600">Am primit mesajul tău și te contactăm în curând.</p>
                    </div>
                  ) : (
                    <form onSubmit={handleSubmit} className="space-y-5">
                      ...
                      <div>
                        <label className="block text-sm font-medium text-slate-700 mb-2">Serviciu dorit</label>
                        <Select
                      ...
                      <div>
                        <label className="block text-sm font-medium text-slate-700 mb-2">Mesaj (opțional)</label>
                        <Textarea
                          name="message"
                      ...
                      >
                        {isLoading ? (
                          <><Loader2 className="w-5 h-5 mr-2 animate-spin" /> Se trimite...</>
                        ) : (
                          <><Send className="w-5 h-5 mr-2" /> Trimite cererea</>
                        )}
                      </Button>

                      <p className="text-xs text-center text-slate-500">
                        Prin trimiterea formularului, ești de acord cu{' '}
                        <a href="#" className="text-sky-500 hover:underline">politica de confidențialitate</a>.
                      </p>
                    </form>
                  )}
                </div>
